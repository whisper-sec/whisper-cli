...
// TestFriendlyMapsKnownProblems asserts the mapping: known server problems collapse
...
// a goroutine/file:line dump ("never a Go stack trace"). It does NOT feed a naked
